...
export function Dashboard() {
    ...
    try {
      ...
      if (loadedTeam) {
        ...
        try {
          ...
          console.error('Error loading tabelle:', err);
        }
  ...
  }, [myTeamIds, loadData]); // loadData ist stabil durch useCallback
  ...
  const handleDatabaseReset = async () => {
    ...
    try {
      ...
      console.error('❌ Database Reset fehlgeschlagen:', err);
    }
  };
        ...
        {currentView === 'overview' && (
          <div className="space-y-6">
            <div>
              ...
              {syncError && (
                <div role="alert" className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg flex items-center justify-between">
                  <span className="text-red-700 text-sm">⚠️ Sync fehlgeschlagen: {syncError}</span>
                  <button
